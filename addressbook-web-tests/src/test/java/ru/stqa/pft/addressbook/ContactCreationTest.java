...
public class ContactCreationTest {
  ...
  @Test
    ...
    fillNewContractForm(new NewContactData("Test01", "Test02", "123", "123@mail.com"));
  ...
  private void submitNewContractCreation() {
    wd.findElement(By.xpath("//div[@id='content']/form/input[21]")).click();
  }

  private void fillNewContractForm(NewContactData newContactData) {
    ...
    wd.findElement(By.name("home")).sendKeys(newContactData.getHomeTelephoneNumber());
